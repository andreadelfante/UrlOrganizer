...
class RunExperiments:
    ...
    def __init__(self, direct, separator="\\t",
        ...
        triple_list_with_b = self.__converter.get_triple_list(list_codes_url=url_codes_with_b,
                                                       learned_labels=learned_labels_with_b)
        triple_list_no_b = self.__converter.get_triple_list(list_codes_url=url_codes_no_b,
